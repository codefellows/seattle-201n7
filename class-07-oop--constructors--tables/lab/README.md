...
Today's working branch will be `lab07-tables`.
...
1. When your work is complete and ready for submission, **open a Pull Request** from `lab07-tables` to `master`.
2. Submit the link to the above Pull Request to Canvas
3. Add a comment to this Canvas submission with answers to the following questions.
  - How did this go, overall?
  - What observations or questions do you have about what you've learned so far?
4. Once you've submitted your work, complete the merge of `lab07-tables` to `master`
